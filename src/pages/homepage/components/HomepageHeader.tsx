    ...
    <div className="flex w-full justify-center overflow-hidden py-14">
      <div className="mx-8 flex w-full max-w-7xl gap-8">
        ...
        <div className="flex flex-[2] gap-8 max-xl:mr-[-100px]">
          <div className="max-h-[420px] min-h-[420px] min-w-[170px] max-w-[170px] overflow-hidden rounded-2xl max-xl:min-w-[150px] max-xl:max-w-[150px]">
            <img
              src={`${baseUploadsUrl}${data.homepage_section_1_left_image?.formats?.large?.url || data.homepage_section_1_left_image.url}`}
              className="h-full w-full object-cover"
              alt={data.homepage_section_1_left_image.name}
            />
          </div>
          <div className="max-h-[420px] min-h-[420px] min-w-[370px] max-w-[370px] overflow-hidden rounded-2xl max-xl:min-w-[350px] max-xl:max-w-[350px]">
            <img
              src={`${baseUploadsUrl}${data.homepage_section_1_middle_image?.formats?.large?.url || data.homepage_section_1_middle_image.url}`}
              className="h-full w-full object-cover"
              alt={data.homepage_section_1_middle_image.name}
            />
          </div>
          <div className="max-h-[420px] min-h-[420px] min-w-[220px] max-w-[220px] overflow-hidden rounded-2xl max-xl:min-w-[200px] max-xl:max-w-[200px]">
            <img
              src={`${baseUploadsUrl}${data.homepage_section_1_right_image?.formats?.large?.url || data.homepage_section_1_right_image.url}`}
              className="h-full w-full object-cover"
