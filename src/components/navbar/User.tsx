  ...
  return (
    <div className="flex items-center gap-5">
      ...
      <div className="relative flex items-center gap-3">
        {userData.user.avatar !== '' && userData.user.avatar !== null ? (
          <img
            src={`http://localhost:1337/uploads/${userData.user.avatar}`}
            className="h-10 w-10 cursor-pointer rounded-full"
          />
        ) : (
          <div className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-primary text-white capitalize">
